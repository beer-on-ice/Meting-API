...
<head>
  ...
  <link rel="shortcut icon" href="https://imgs.mistyhill.ml/file/9034ecd914bcb49ab9b18.png" type="image/x-icon" />
...
<body>
  <main>
    <div class="ico">
      <img src="https://imgs.mistyhill.ml/file/9034ecd914bcb49ab9b18.png" alt="logo">
    </div>
    <div class="title">Meting-Api</div>
  ...
  <footer>
    ...
    <div class="power">
      ...
      <a href="https://mistyhill.ml/" target="_blank">霧山</a>
    </div>
    <div class="icp">
      <a href="https://icp.gov.moe/?keyword=20233016/" target="_blank">萌ICP备20233016号</a>
    </div>
  </footer>
  <script>
    // 跟随系统主题
    ...
    const socialJump = (type) => {
      switch (type) {
        case "github":
          window.location.href = "https://github.com/beer-on-ice/"
          break
        case "home":
          window.location.href = "https://www.mistyhill.ml/"
          break
        case "email":
          window.location.href = "mailto:mail@sob.im"
          break
        default:
          break
      }
